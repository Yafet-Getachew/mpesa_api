...
class B2CRequestAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('phone', 'amount', 'conversation_id', 'originator_conversation_id',
...
class B2CResponseAdmin(admin.ModelAdmin):
    list_display = ('phone', 'amount', 'transaction_receipt', 'mpesa_user_name')
    readonly_fields = ('phone', 'amount', 'conversation_id', 'originator_conversation_id',
                       'result_type', 'result_code', 'result_description', 'transaction_id',
                       'transaction_receipt', 'transaction_amount', 'working_funds',
